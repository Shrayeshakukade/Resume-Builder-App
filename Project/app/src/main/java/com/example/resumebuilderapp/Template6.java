...
public class Template6 extends AppCompatActivity {
    ...
    private String nme,add1,add2,add3,eml,phno,skil1,skil2,skil3,com,from,role,to,insti,dob,lang,nation;
    private String int1,int2,int3,t1,t2,des1,des2,du1,du2,a1,a2,cg,course,sname,smks,hname,hmks,yearop;
    ...
    public void createpdf(View view){
        Context context=Template6.this;
        PrintManager printManager=(PrintManager)Template6.this.getSystemService(context.PRINT_SERVICE);
    ...
    public void code()
    {
        String html="<!DOCTYPE html>\n" +
                ...
                "<head>\n" +
                "\t<title>resume4</title>\n" +
                "\t<link rel=\"stylesheet\" type=\"text/css\" href=\"file:android_asset/resume4.css\">\n" +
                "</head>\n" +
                "<body>\n" +
                "\t<div id=\"sideleft\">\n" +
                ...
                "\t\t<h4><img src=\"file:android_asset/mail.png\"> "+eml+"</h4>\n" +
                "\t\t<h4 id=\"pnho\"><img src=\"file:android_asset/phonecall.png\">"+phno+"</h4>\n" +
                ...
                "<h4 id=\"pt1\">Project Title:"+t1+"</h4>\n" +
                "<h4 id=\"des1\">Title Description:"+des1+"</h4></h4>\n" +
                "<h4 id=\"du1\">Duration:"+du1+"</h4>\n" +
                "<br>\n" +
                "<h4 id=\"pt1\">Project Title:"+t2+"</h4>\n" +
                "<h4 id=\"des1\">Title Description:"+des2+"</h4></h4>\n" +
                "<h4 id=\"du1\">Duration:"+du2+"</h4>\n" +
                "\n" +
                "</div>\n" +
                "</body>\n" +
                "</html> ";
