...
public class Template8 extends AppCompatActivity {
    ...
    private String nme,add1,add2,add3,eml,phno,skil1,skil2,skil3,com,from,role,to,cg,yearop,course;
    ...
    public void createpdf(View view){
        Context context=Template8.this;
        PrintManager printManager=(PrintManager)Template8.this.getSystemService(context.PRINT_SERVICE);
    ...
    public void code()
    {
        String html="<!DOCTYPE html>\n" +
                ...
                "        <font size=\"3\" id=\"yop\">Year of Passing:"+yearop+"</font>\n" +
                "        <br>\n" +
