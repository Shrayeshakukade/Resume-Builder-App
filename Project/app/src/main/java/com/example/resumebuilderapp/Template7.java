...
public class Template7 extends AppCompatActivity {
    ...
    private String nme,add1,add2,add3,eml,phno,skil1,skil2,skil3,com,from,role,to,cg,course,yearop;
    private String insti,du1,des1,des2,du2,int1,int2,int3,a1,a2,dob,lang,nation,t1,t2,sname,smks,hname,hmks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff2=FirebaseDatabase.getInstance().getReference(firebaseAuth.getUid()).child("fresherinfo");
    ...
    public void code()
    {
        String html="<!DOCTYPE html>\n" +
                ...
                "  <h4 id=\"email\"><img src=\"mail.png\">  email@gmail.com</h4>\n" +
                "  <h4 id=\"phno\"><img src=\"phonecall.png\">"+phno+"</h4>\n" +
                "  <h3><img src=\"user.png\">  PERSONAL PROFILE</h3>\n" +
                "  <!--personal details here -->\n" +
                "  <h4 id=\"dob\">Date of birth:"+dob+"</h4>\n" +
                "  <h4 id=\"lang\">Known languages:"+lang+"</h4></h4>\n" +
                "  <h4 id=\"nation\">Nationality:"+nation+"</h4>\n" +
                "  <h3><img src=\"tools.png\">  TECHNICAL SKILLS</h3>\n" +
                "  <h4 id=\"skil1\">"+skil1+"</h4>\n" +
                "  <h4 id=\"skil2\">"+skil2+"</h4>\n" +
                "  <h4 id=\"skil3\">"+skil3+"</h4>\n" +
                "\n" +
                "  <h3><img src=\"thumbsup1.png\">  INTERESTS</h3>\n" +
                "  <h4 id=\"inte1\">"+int1+"</h4>\n" +
                "  <h4  id=\"inte2\">"+int2+"</h4>\n" +
                "  <h4  id=\"inte3\">"+int3+"</h4>\n" +
                "  </h4>\n" +
                "</div>\n" +
                "<div id=\"header\">\n" +
                "  <h3><img src=\"education.png\">  EDUCATION</h3>\n" +
                ...
                "\n" +
                "  <h3><img src=\"experience.png\">INTERNSHIP</h3>\n" +
                "  <h4 id=\"role\">Role:"+role+"</h4>\n" +
                "  <h4 id=\"company\">Company Name:"+com+"</h4>\n" +
                "  <h4 id=\"duration\">Duration:from "+from+" to "+to+"</h4>\n" +
                "\n" +
                "  <h3><img src=\"trophy.png\">  AWARDS AND ACHIEVEMENTS</h3>\n" +
                "  <h4 id=\"ach1\">"+a1+"</h4>\n" +
                "  <h4 id=\"ach2\">"+a2+"</h4>\n" +
                "  <h3><img src=\"projects.png\">  PROJECTS</h3>\n" +
